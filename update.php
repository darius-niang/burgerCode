...
if(!empty($_POST)){
    ...
    if(empty($name)){
        $nameError = "Remplissez ce champ d'abord";
        $isSuccess = false;
    }
    if(empty($description)){
        $descriptionError = "Remplissez ce champ d'abord";
        $isSuccess = false;
    }
    if(empty($price)){
        $priceError = "Remplissez ce champ d'abord";
        $isSuccess = false;
    }
    if(empty($category)){
        $categoryError = "Remplissez ce champ d'abord";
        $isSuccess = false;
    }
    if(empty($image)){
